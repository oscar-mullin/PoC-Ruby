Feature: Theme Editor
  ...
  Scenario Outline: ENG-11827 - Verify that the navigation bar adjusts to the logo's height (Logo's Height 30px)
    ...
    And I click on "Theme Editor" option
  ...
  Examples:
    | site                                   | user  | logo_path     |
    | Non-Challenge community - Theme Editor | admin | logo_30px.jpg |
    | Challenge community - Theme Editor     | admin | logo_30px.jpg |
  ...
  Examples:
    | site                                   | user  | logo_path     |
    | Non-Challenge community - Theme Editor | admin | logo_60px.jpg |
    | Challenge community - Theme Editor     | admin | logo_60px.jpg |
  ...
  Examples:
    | site                                   | user  | logo_path      |
    | Non-Challenge community - Theme Editor | admin | logo_120px.jpg |
    | Challenge community - Theme Editor     | admin | logo_120px.jpg |
  ...
  Scenario Outline: ENG-11828 - Verify navigation bar Text Color can be changed (From the Color Wheel)
    ...
    When I click on "Theme Editor" option
  ...
  Examples:
    | site                                   | user  | new_color |
    | Non-Challenge community - Theme Editor | admin | _         |
    | Challenge community - Theme Editor     | admin | _         |
  ...
  Examples:
    | site                                   | user  | hex_color |
    | Non-Challenge community - Theme Editor | admin | #428eff   |
    | Challenge community - Theme Editor     | admin | #428eff   |
