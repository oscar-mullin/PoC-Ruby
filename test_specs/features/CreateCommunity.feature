Feature: Create Community
  ...
  Examples:
    ...
    | Non-Challenge community - Admin Settings  | superadmin  | non-challengecommunity-adminsettings  | challengeadminsettin  |
  ...
  Examples:
    ...
    | Non-Challenge community - Admin Settings  | superadmin  | autocommdefaultsettings | Auto Comm Default Settings  | Auto Comm Default Settings  | auto,default  |
